...
const char* wifiPassword = "<INSERT>";

const char* user = "lafortuna-test1";
const char* matrixPassword = "lafortuna123";
const char* roomId = "!ObbicGuhLAdVaShsWJ:matrix.org";
    ...
    if (rc == HTTP_CODE_OK) {
      ...
      if (lastMessageToken != "") {
        ...
        if (content.containsKey("body")) {
          ...
          Serial.print("<"+sender.substring(1,sender.indexOf(':',1))+"> ");
          Serial.println(body);
